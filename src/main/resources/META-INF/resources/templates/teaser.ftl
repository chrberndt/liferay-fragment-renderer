<#assign parameterNames = request.getParameterNames() />
<#assign attributeNames = request.getAttributeNames() />
<#assign instanceId = "" />
...
<#assign headline = "Headline not available" />
<#assign description = "Description not available" />
...
<#if article??>
    ...
    <#if instanceId?? && instanceId?has_content>
        <#if journalArticleUtil.getArticleNode(groupId, articleId, instanceId)??>
            ...
            <#if teaser??>
                <#assign headline = teaser.selectSingleNode("./dynamic-element[@name='Headline']").getStringValue() />
                <#assign description = teaser.selectSingleNode("./dynamic-element[@name='Description']").getStringValue() />
            </#if>
        </#if>
    </#if>
</#if>
